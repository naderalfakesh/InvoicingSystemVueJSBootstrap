  ...
  <div class="animated fadeIn">
    <b-row>
      <b-col sm="12">
        ...
        v-on:edit-row="edit"
        v-on:del-row="del" :table-data="invoices" :fields="fields" :per-page=10 hover striped bordered  fixed caption="<i class='fa fa-align-justify'></i> Combined All Table"></c-table>
      </b-col>
    </b-row>
...
export default {
  ...
  methods:{
    ...
    show: function(value){
      this.$router.push({name: 'invoiceView' , params: { "invoice" : value } })
    },
    edit: function(value){
      this.$router.push({name: 'invoiceCreate' , params: { "invoice" : value } })
    },
    del: function(value){
      axios
        .delete('http://localhost:5000/invoice/'+value._id)
        .then(res => {
          console.log(res.data);
          this.invoices = this.invoices.filter(function(val){return val._id != value._id})
          })
        .catch(err => console.log(err))
    },
  }
